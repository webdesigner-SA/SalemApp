...
import MapView, { PROVIDER_GOOGLE, Marker } from 'react-native-maps'; //must install it
    ...
    <View style={styles.container}>
      ...
      <BottomSheet ref={bottomSheetRef}>
        ...
        <Text style={styles.bottomSheetText}>
          جاهز لبدء تجربتك مع سالم؟
        </Text>

        {/* Button in the bottom sheet */}
        <TouchableOpacity style={styles.bottomSheetButton}>
          <Text style={{ color: 'white', fontSize: 18, fontWeight: 'bold' }}>إبدأ الآن</Text>
        </TouchableOpacity>
